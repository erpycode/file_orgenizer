...
class FileOrganizerGUI:
    ...
    def setup_ui(self):
        ...
        source_frame = tk.Frame(
            main_frame, bg="#2d2d44", padx=12, pady=10, relief=tk.RIDGE, bd=1
        )
        ...
        source_entry_frame.pack(fill=tk.X, pady=(8, 0))
        ...
        auto_btn.pack(side=tk.RIGHT, padx=(0, 6))
        ...
        target_info = tk.Frame(
            mode_frame, bg="#1e1e2e", padx=10, pady=6, relief=tk.FLAT, bd=1
        )
        target_info.pack(fill=tk.X, pady=(8, 0))

        tk.Label(
            target_info,
            text="🎯 Target: [source]/exported/ (auto-sorted by file type)",
            font=("Segoe UI", 9),
            bg="#1e1e2e",
            fg="#888888",
        ).pack(anchor=tk.W)
        ...
        custom_frame.pack(fill=tk.X, pady=(0, 12))
        ...
        custom_input_frame.pack(fill=tk.X, pady=(8, 0))
        ...
        self.custom_folder.pack(side=tk.LEFT, padx=(5, 8))
        ...
        self.custom_list.pack(fill=tk.X, pady=(6, 0))
        ...
        del_btn.pack(anchor=tk.E, pady=(4, 0))
        ...
        h_scroll = ttk.Scrollbar(
            text_frame, orient=tk.HORIZONTAL, command=self.result_text.xview
        )
    ...
    def run_operation(self):
        ...
        threading.Thread(
            ...
            args=(self.operation_mode.get(), False),
            daemon=True,
        ).start()
    ...
    def dry_run(self):
        ...
        threading.Thread(
            target=self.process_files,
            args=(self.operation_mode.get(), True),
            daemon=True,
        ).start()
